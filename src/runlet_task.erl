...
insn(Options) ->
    ...
    Root = filename:absname_join(Cwd,
                                 proplists:get_value(root, Options,
                                                     "priv/root")),
    Opt = filename:absname_join(Cwd,
